jeffcpullen.agnosticp agp_devspaces Role
========================
...
- name: Execute tasks on servers
  hosts: servers
  roles:
    - role: jeffcpullen.agnosticp.agp_devspaces
      agp_devspaces_x: 42
```
...
```yaml
- name: Initialize the agp_devspaces role from jeffcpullen.agnosticp
  hosts: servers
  gather_facts: false
  tasks:
    - name: Trigger invocation of agp_devspaces role
