jeffcpullen.agnosticp agp_devspaces_samples Role
========================
...
- name: Execute tasks on servers
  hosts: servers
  roles:
    - role: jeffcpullen.agnosticp.agp_devspaces_samples
      agp_devspaces_samples_x: 42
```

Another way to consume this role would be:

```yaml
- name: Initialize the agp_devspaces_samples role from jeffcpullen.agnosticp
  hosts: servers
  gather_facts: false
  tasks:
    - name: Trigger invocation of agp_devspaces_samples role
